...
SECRET_KEY = 'django-insecure-z_-xia9b3p5svsdz98=cru5j@y0z6-wxw@cvdd&s^12q9g$)_@'
...
MIDDLEWARE = [
    ...
    'music_app.middleware.SpotifyMiddleware',
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            (os.path.join(BASE_DIR,'music_app','templates')),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
